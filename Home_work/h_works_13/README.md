...
###  4. Настройка NTP.  
 ...
 ### Вопрос для повторения.
   ...
   Ответ: Протоколы обнаружения сетевых устройств, не стоит использовать на пользовательских портах, и интерфейсах подключеных к не довереным зонам (например провайдер, подрядичик и т.д.). Для предотвращения взлома(Заполучение информаций об оборудований, IP адресах и т.д.). Раскрытие структуры сети.
